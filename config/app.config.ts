...
export const appConfig = {
	appName: "GOAT OS",
	description: `Plataforma integral para la gestión deportiva de alto rendimiento`,
	baseUrl: getBaseUrl(),
	// Contact information (used for enterprise inquiries)
	contact: {
		enabled: false,
		email: "contacto@goatos.com",
		phone: "",
		address: "",
	},
