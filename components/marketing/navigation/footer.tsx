...
const footerLinks = [
	...
	},
	{
		...
		items: [
			...
			{ title: "Novedades", href: "/changelog" },
		],
	},
	{
		group: "Empresa",
	...
	},
	{
		group: "Legal",
		items: [
			{ title: "Politica de Privacidad", href: "/legal/privacy" },
			{ title: "Terminos de Servicio", href: "/legal/terms" },
			{ title: "Politica de Cookies", href: "/legal/cookies" },
		],
	},
];
				...
				<div className="mx-auto flex max-w-7xl flex-col gap-16 px-6 lg:px-10">
					...
					<div className="flex flex-col items-center justify-between gap-8 border-t border-marketing-border pt-8 sm:flex-row text-sm">
						<div className="text-marketing-fg-muted order-2 sm:order-1">
							© {new Date().getFullYear()} {appConfig.appName}. Todos los
							derechos reservados.
						</div>
