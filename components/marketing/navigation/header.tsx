...
const PRODUCT_LINKS = [
	{
		...
		href: "/#features",
		description: "Explora todas las herramientas para potenciar el rendimiento.",
	},
	{
		title: "Preguntas Frecuentes",
		href: "/#faq",
		description: "Encuentra respuestas a las preguntas mas comunes.",
	},
];
...
export function Header() {
	...
	const companyLinks = [...COMPANY_LINKS];
