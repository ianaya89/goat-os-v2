...
function TableHeader({
	...
	return (
		<thead
			...
			// Sharp & Bold: stronger header border
...
function TableRow({ className, ...props }: TableRowProps): React.JSX.Element {
	return (
		<tr
			data-slot="table-row"
			// Sharp & Bold: cleaner hover, selected state with primary tint
			className={cn(
...
function TableHead({ className, ...props }: TableHeadProps): React.JSX.Element {
	return (
		<th
			...
			// Sharp & Bold: taller header, semibold uppercase text
			className={cn(
				"h-12 px-4 text-left align-middle font-semibold text-foreground text-xs uppercase tracking-wider whitespace-nowrap",
...
function TableCell({ className, ...props }: TableCellProps): React.JSX.Element {
	return (
		<td
			...
			// Sharp & Bold: consistent padding with header
			className={cn(
