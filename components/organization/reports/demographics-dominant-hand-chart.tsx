...
export function DemographicsDominantHandChart(): React.JSX.Element {
	...
	const chartData = (data?.dominantHand ?? [])
		...
		<Card>
			<CardHeader>
				<CardTitle className="flex items-center gap-2">
					<HandIcon className="h-5 w-5 text-violet-600" />
					{t("charts.dominantHand.title")}
				</CardTitle>
				<CardDescription>
					{t("charts.dominantHand.description")}
				</CardDescription>
			</CardHeader>
			<CardContent>
				{chartData.length === 0 ? (
