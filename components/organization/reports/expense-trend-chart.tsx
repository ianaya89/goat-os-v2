...
export function ExpenseTrendChart({
	dateRange,
	period,
}: ExpenseTrendChartProps): React.JSX.Element {
	const { data, isLoading } =
		trpc.organization.reports.getExpensesByPeriod.useQuery({
			dateRange,
			period,
		});
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Total: {formatAmount(totalExpenses)} ({chartData.length} periodos)
				</CardDescription>
			</CardHeader>
			<CardContent>
				{chartData.length === 0 ? (
