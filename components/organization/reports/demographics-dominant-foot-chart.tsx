...
export function DemographicsDominantFootChart(): React.JSX.Element {
	...
	const chartData = (data?.dominantFoot ?? [])
		...
		<Card>
			<CardHeader>
				<CardTitle className="flex items-center gap-2">
					<FootprintsIcon className="h-5 w-5 text-teal-600" />
					{t("charts.dominantFoot.title")}
				</CardTitle>
				<CardDescription>
					{t("charts.dominantFoot.description")}
				</CardDescription>
			</CardHeader>
			<CardContent>
				{chartData.length === 0 ? (
